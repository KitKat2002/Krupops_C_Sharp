...
namespace ConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Type in four more books to add to the array");

            books[0] = Console.ReadLine();
            books[1] = Console.ReadLine();
            books[2] = Console.ReadLine();
            books[3] = Console.ReadLine();
            books[4] = "Old Yeller";
            books[5] = "The Chronicals of Narnia: The Lion, The Witch, And The Wardrobe";
            books[6] = "It";
            books[7] = "How to Train Your Dragon";
            books[8] = "11 Seconds";
            ...
            List<string> flowers = new List<string>() { "\n Poppy", "Sunflower", "Black-Eyed Susan", "Rose", "Chrysanthemum", "Daffodil", "Lotus"};
            ...
            Console.WriteLine("\nDisplay of list items: " + string.Join(", ", animalslistTwo));
